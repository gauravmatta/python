...
if button:
    if prompt:
        ...
        while True:
            ...
            # 2. Setup Output Capture, we redirect stdout to capture print statements and errors.
            ...
            if "Error executing generated code" in output:
                ...
                prompt = f"""
                The following code has this error: {output} Code:
                # {code} """
...
if ask:
    ...
    prompt = f""" Can you explain why we used this code "{question}" in the following code in very detail step by step: {st.session_state["response"]}"""
